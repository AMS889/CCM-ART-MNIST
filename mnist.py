...
# This is ripped directly from https://github.com/pytorch/vision/blob/master/torchvision/datasets/mnist.py because the EMNIST module doesn't seem to implemented in torchvision for some reaason ¯\_(ツ)_/¯
